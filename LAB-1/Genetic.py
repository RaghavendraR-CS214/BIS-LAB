...
2. generate the population within a bound with a given size 
3. select individuals based on the probability. 
4. crossover of two parents if the random value is below the crossover rate else return the parent itself. 
5. mutate - add a bit amount of mutation to the individual so that there can be a bit of variation in the children or succesive generation. 
6. main function to run all the above one by one within generations and print the best fitness of the generation.
'''